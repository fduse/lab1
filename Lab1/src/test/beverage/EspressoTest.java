...
public class EspressoTest {
	...
	public void testCost() {
		Assert.assertEquals(1.4, es.cost(), 0);//0.4+1.0=0.4
		Assert.assertEquals(1.7, em.cost(), 0);//0.7+1.0=1.7
		Assert.assertEquals(2.0, el.cost(), 0);//1.0+1.0=2.0
		Assert.assertEquals(2.3, eg.cost(), 0);//1.3+1.0=2.3
